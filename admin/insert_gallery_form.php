...
<body>
    ...
    <main>
        <form action="./php/insert_gallery.php" method="post" enctype="multipart/form-data">
            <div class="box2">
                <div class="input_data_1">
                    <h2>上傳作品集</h2><br>
                    
                    <label>選擇圖片：
                        <input class="input_3" type="file" name="image" accept="image/*" required>
                    </label>
                    <textarea class="textarea_2" name="description" placeholder="圖片描述"></textarea>
                    <br>
                    <button type="submit">上傳並新增</button>
                </div>
            </div>
        </form>
    </main>
